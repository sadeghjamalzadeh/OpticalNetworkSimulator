...
${OBJECTDIR}/src/Calls/CallDevices.o: src/Calls/CallDevices.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Calls
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Calls/CallDevices.o src/Calls/CallDevices.cpp
...
${OBJECTDIR}/src/ResourceAllocation/TSA.o: src/ResourceAllocation/TSA.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ResourceAllocation
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ResourceAllocation/TSA.o src/ResourceAllocation/TSA.cpp
...
${OBJECTDIR}/src/SimulationType/MultiNumSbvtSimulation.o: src/SimulationType/MultiNumSbvtSimulation.cpp
	${MKDIR} -p ${OBJECTDIR}/src/SimulationType
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SimulationType/MultiNumSbvtSimulation.o src/SimulationType/MultiNumSbvtSimulation.cpp
...
${OBJECTDIR}/src/Structure/Nodes/NodeSBVT.o: src/Structure/Nodes/NodeSBVT.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Structure/Nodes/NodeSBVT.o src/Structure/Nodes/NodeSBVT.cpp
